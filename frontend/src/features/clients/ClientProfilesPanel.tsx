...
export function ClientProfilesPanel({
  ...
  const assign = useLogicalCommandMutation(
    async (
      input: { profileId: string; assignmentId: string; reason: string },
      idempotencyKey,
    ) => {
  ...
  return (
    <section className="panel full-span">
      ...
      >
        ...
        <label htmlFor={`client-profile-assignment-id-${clientId}`}>Assignment ID</label>
        <input id={`client-profile-assignment-id-${clientId}`} name="assignmentId" required placeholder="assignment_..." />
