...
CLASSIFIERS = [
    ...
    ("client_mail", "crates/control-plane-contract/src/routes/client_mail.rs"),
...
ROUTE_SPECS = [
    ...
    ("ClientMailSearchApi", "client_mail", ["POST"], "/api/v1/tenants/{tenant_id}/clients/{client_id}/mail/search", "/api/v1/tenants/tenant_01/clients/client_01/mail/search", True),
    ("ClientMailMessageApi", "client_mail", ["POST"], "/api/v1/tenants/{tenant_id}/clients/{client_id}/mail/message", "/api/v1/tenants/tenant_01/clients/client_01/mail/message", True),
    ("ClientMailSendApi", "client_mail", ["POST"], "/api/v1/tenants/{tenant_id}/clients/{client_id}/mail/send", "/api/v1/tenants/tenant_01/clients/client_01/mail/send", True),
