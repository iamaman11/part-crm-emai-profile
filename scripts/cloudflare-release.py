...
def self_test() -> None:
    with tempfile.TemporaryDirectory(prefix="cloudflare-release-self-test-") as temporary:
        ...
        if not isinstance(schema_contract, dict) or not (
            ...
            and schema_contract.get("target_schema_revision") == "0030_profile_generation_successor_commit.sql"
            and schema_contract.get("supported_schema_min") == "0030_profile_generation_successor_commit.sql"
            and schema_contract.get("supported_schema_max") == "0030_profile_generation_successor_commit.sql"
        ):
