...
def validate_docs() -> None:
    ...
    required_plan_markers = (
        ...
        "Phase 2H was accepted through issue #163 / PR #164",
        ...
        "| A8 | Query-side/CQRS read-model boundary | **Accepted in Phase 2D and preserved through Phase 2H.**",
        "| 6.2 | Durable-before-notify | **Accepted through Phase 2H.**",
        "| 6.3 | At-least-once consumer idempotency | **Accepted through Phase 2H.**",
        "| 6.4 | Authorization-before-projection | **Accepted through Phase 2H.**",
    ...
    required_matrix_markers = (
        ...
        "| A5 | Feature-sliced SPA route composition | **Accepted through Phase 2H**",
        "| A8 | CQRS/read-model boundary | **Accepted through Phase 2H**",
        "| 6.2 | Durable-before-notify | **Accepted through Phase 2H.**",
        "| 6.3 | At-least-once consumer idempotency | **Accepted through Phase 2H.**",
        "| 6.4 | Authorization-before-projection | **Accepted through Phase 2H.**",
