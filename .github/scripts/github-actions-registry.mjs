...
function validatePolicy(policy, trackedPaths) {
  ...
  expect(registrations.length === 16, 'registry policy must classify exactly 16 current active registrations');
  ...
  expect(registrations.filter((entry) => entry.category === 'PERMANENT_REQUIRED').length === 15, 'registry policy must classify exactly 15 permanent workflows');
