...
mod tests {
    ...
    use application_ports::CommandExecutionEvidence;
    use application_ports::clients::{
        ClientApplicationPort, ClientCreateWrite, ClientPortError, ClientReadModel,
        ClientReplayDecision, ClientReplayReceipt,
    };
    ...
    #[test]
    fn visible_query_preserves_accepted_shape() -> Result<(), Box<dyn std::error::Error>> {
