...
pub struct CapabilityProfile {
    ...
    pub authorization: ProfileAuthorization,
...
pub fn select_profile(
    ...
    profile_id: &str,
    profile_digest: &str,
) -> Result<CapabilityProfile, ProfileSelectionError> {
...
mod tests {
    ...
    fn route_activation_is_finer_than_application_owner() {
        assert_eq!(
            route_activation_unit(RouteClass::ClientMailSearchApi, "/api/v1/tenants/t/clients/c/mail/search"),
            Some(ActivationUnit::MailboxRead)
        );
        assert_eq!(
            route_activation_unit(RouteClass::ClientMailSendApi, "/api/v1/tenants/t/clients/c/mail/send"),
